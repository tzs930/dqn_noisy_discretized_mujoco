# This implementation code is modified from stable_baselines.trpo_mpi.trpo_mpi.py
# https://github.com/Stable-Baselines-Team/stable-baselines/blob/master/stable_baselines/trpo_mpi/trpo_mpi.py
import time
...
class POfD(ActorCriticRLModel):
    """
    Policy Optimization from Demonstration (http://proceedings.mlr.press/v80/kang18a/kang18a.pdf)
    ...
    def __init__(self, policy, env, demo_dataset=None, gamma=0.99, timesteps_per_batch=5000, max_kl=0.01, cg_iters=10,
        ...
        self.rewcoeff = rewcoeff       # This term is lambda 1 in the paper
        self.entcoeff = entcoeff       # This term is lambda 2 in the paper
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            with self.sess.as_default():
                seg_gen = traj_segment_generator(self.policy_pi, self.env, self.timesteps_per_batch,
                                                 reward_giver=self.reward_giver, rewcoeff=self.rewcoeff)
