# This implementation code is modified from stable_baselines.trpo_mpi.utils.py
# https://github.com/Stable-Baselines-Team/stable-baselines/blob/master/stable_baselines/trpo_mpi/utils.py
...
def traj_segment_generator(policy, env, horizon, reward_giver=None, rewcoeff=0.1):
    """
    ...
    while True:
        ...
        imitate_reward = reward_giver.get_reward(observation, clipped_action[0])
        observation, true_reward, done, info = env.step(clipped_action[0])
        reward = true_reward + rewcoeff * imitate_reward
